 ...
 * 순위 워커 · 대량 수집 · SERP 대행
 *
 * 한때 웹스토어 심사를 의식해 별도 빌드로 분리했다가, 쇼핑 주문을 넣는 누구나
 * 상품정보 수집을 쓸 수 있어야 해서 다시 하나로 합쳤다(2026-08-10).
 * 심사 관점의 리스크와 판단 근거는 .claude/30_EXTENSION_PUBLIC_INTERNAL_SPLIT.md 참조.
 *
 * ⚠️ 이 블록은 `const handlers`(위쪽) 이후여야 한다 — TDZ.
 * ────────────────────────────────────────────────────────────────────────── */
