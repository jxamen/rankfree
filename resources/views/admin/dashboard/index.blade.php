...
<div class="dash-cols">
    ...
    <div>
        ...
        <div class="card p-5" style="margin-top:14px;">
            ...
            {{-- 발행 문서수는 뺐다 — keyword_searches 풀스캔이라 집계 하나에 10초였다(2026-08-05). 허브에서 본다 --}}
            <div class="text-muted-soft" style="font-size:var(--fs-xs);margin-top:10px;">쇼핑과 플레이스가 병렬 처리됩니다 · 발행 현황은 <a href="{{ route('admin.keyword-hub') }}" style="color:var(--color-primary);">키워드 허브</a>에서 봅니다</div>
        </div>
    </div>
</div>
