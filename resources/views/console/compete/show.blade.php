...
<div style="max-width:1040px;">
    ...
    @else
        ...
        <p class="text-muted-soft" style="font-size:11px;">N1 유사도·N2 관련성·N3 랭킹 및 세부지표(D1~D10)는 관측 신호 기반 <b>자체 추정치</b>이며 네이버 공식 점수가 아닙니다. 리뷰 최근성(D9)·영향력(D10)은 추후 반영됩니다.</p>
    @endunless
</div>
@endsection
