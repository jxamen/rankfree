...
@section('title', $slot->keyword.' 쇼핑 순위 리포트 · rankfree')
...
<section class="container-page" style="padding-top:48px;padding-bottom:80px;">
    <div class="mb-6">
        <div class="badge mb-3 border border-hairline">쇼핑 순위 추적 리포트 · rankfree</div>
    ...
    <p class="text-muted-soft mt-3" style="font-size:var(--fs-xs);">
        순위 변동은 전일 대비(＋상승/−하락). 순위는 네이버 쇼핑 검색(정확도순) 기준 rankfree 자체 수집 데이터입니다.
    </p>
