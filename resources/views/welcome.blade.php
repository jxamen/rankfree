                ...
                <div class="p-5">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex items-center gap-3 py-2.5 border-b border-hairline-soft">
                            <span class="inline-flex items-center justify-center w-6 h-6 rounded-md bg-surface-card text-ink font-semibold" style="font-size:12px;">{{ $row[0] }}</span>
                            <span class="text-ink flex-1" style="font-size:14px;">{{ $row[1] }}</span>
                            <span class="text-muted-soft" style="font-size:12px;">{{ $row[2] }}</span>
                        </div>
                        @endforeach
                    </div>
                </div>
    ...
    <div class="container-page py-20 lg:py-24">
        ...
        <div class="grid gap-6 md:grid-cols-3">
            ...
            <div class="card-soft p-8">
                ...
                <h3 class="mt-4 text-ink font-semibold" style="font-size:18px;">{{ $f[1] }}</h3>
                <p class="mt-2 text-muted" style="font-size:15px;line-height:1.6;">{{ $f[2] }}</p>
            </div>
            @endforeach
        </div>
    </div>
        ...
        <div class="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
                ...
                <ul class="mt-6 flex flex-col gap-3">
                    @foreach (['키워드별 일간 순위 추이 그래프','상위 30위 경쟁사 리뷰·저장·예약 비교','공유 링크로 리포트 전달 (로그인 불필요)'] as $li)
            ...
            <div class="card p-6" style="box-shadow:var(--shadow-soft);">
                ...
                <svg viewBox="0 0 400 160" class="w-full" style="height:auto;">
                    ...
                    <circle cx="{{ explode(',', $pt)[0] }}" cy="{{ explode(',', $pt)[1] }}" r="3" fill="var(--color-primary)" />
                    @endforeach
                </svg>
    ...
    <div class="container-page py-20 lg:py-24">
        ...
        <div class="grid gap-6 md:grid-cols-3">
            ...
            <div class="card p-8 flex flex-col">
                <h3 class="text-ink font-semibold" style="font-size:18px;">{{ $m[0] }}</h3>
                <p class="mt-2 text-muted flex-1" style="font-size:15px;line-height:1.6;">{{ $m[1] }}</p>
