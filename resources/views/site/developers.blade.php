...
@section('description', '랭크프리 오픈 API — 인증 · 순위추적 · 경쟁분석 · 키워드분석 · 쇼핑 유입키워드 · 마케팅 상품 주문 연동 문서')
...
<section class="py-10 lg:py-14 container-page">
    <div class="mb-6">
        ...
        <p class="text-muted mt-1" style="font-size:var(--fs-sm);">랭크프리 오픈 API — 인증 · 순위추적 · 경쟁분석 · 키워드분석 · 쇼핑 유입키워드 · 마케팅 상품 주문</p>
    </div>
