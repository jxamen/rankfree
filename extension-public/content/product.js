...
(function () {
  ...
  function spNodeFrom(pre, extra) {
    ...
    // 2026-08-10: simpleProductForDetailPage 에서 .A 래퍼가 사라져 그 자체가 상품 노드가 됐다.
    //   이 경우 기존 폴백(pre.product)은 name·seoInfo 가 null 인 껍데기라 관련 태그·브랜드·카테고리가 통째로 빈다.
    const sp = pre.simpleProductForDetailPage;
    const A =
